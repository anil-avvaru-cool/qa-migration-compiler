...
def test_locator_extraction(tmp_path):
    java_code = """
    package pages;
    ...
    assert locations[0]["strategy"] == "cssSelector"
    assert locations[1]["strategy"] == "cssSelector"
    assert locations[2]["strategy"] == "cssSelector"